...
QSize Childwidget::minimumSizeHint() const
{
	return QSize(10, 10);
}

QSize Childwidget::sizeHint() const
{
	QRect rect = QApplication::desktop()->screenGeometry();
	return QSize(int(rect.width()*0.8), int(rect.height()*1.0));
}

void Childwidget::setDefaultMaterial(void)
{
	// material
#if 1
...
void Childwidget::setDefaultLight(void)
{
#if 1
	// lighting
...
void Childwidget::resizeGL(int _w, int _h)
{
...
void Childwidget::draw_scene(int drawmode)
{
...
void Childwidget::mousePressEvent(QMouseEvent* _event)
{
...
void Childwidget::mouseMoveEvent(QMouseEvent* _event)
{
	//assert(mouse_mode_ < N_MOUSE_MODES);
...
void Childwidget::mouseReleaseEvent(QMouseEvent* /* _event */)
{
	//assert(mouse_mode_ < N_MOUSE_MODES);
	mouse_mode_ = Qt::NoButton;
...
void Childwidget::wheelEvent(QWheelEvent* _event)
{
...
void Childwidget::keyPressEvent(QKeyEvent* _event)
{
	switch (_event->key())
	{
	case Qt::Key_Q:
...
void Childwidget::translation(QPoint p)
{
...
void Childwidget::translate(const OpenMesh::Vec3d& _trans)
{
...
void Childwidget::rotation(QPoint p)
{
...
void Childwidget::rotate(const OpenMesh::Vec3d& _axis, double _angle)
{
...
bool Childwidget::map_to_sphere(const QPoint& _v2D, OpenMesh::Vec3d& _v3D)
{
...
void Childwidget::update_projection_matrix()
{
	makeCurrent();
	glMatrixMode(GL_PROJECTION);
	glLoadIdentity();
...
void Childwidget::update_projection_matrix_one_viewer()
{
	makeCurrent();
	glMatrixMode(GL_PROJECTION);
	glLoadIdentity();
...
void Childwidget::set_scene_pos(const OpenMesh::Vec3d& _center, float _radius)
{
	Center = _center;
	Radius = _radius;
